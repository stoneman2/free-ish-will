...
namespace FreeWill
{
    public class Dialog_GlobalFocus : Window
    {
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            Widgets.Label(new Rect(0, 0, inRect.width, 30), "FreeWillGlobalFocusTitle".TranslateSimple());
            ...
            y += 30;
            string maxLabel = maxPawns == 0 ? "FreeWillUnlimited".TranslateSimple() : maxPawns.ToString();
            Widgets.Label(new Rect(0, y, 150, 24), "FreeWillMaxPawns".TranslateSimple());
            Widgets.Label(new Rect(160, y, 50, 24), maxLabel);
            y += 24;
            maxPawns = (int)Widgets.HorizontalSlider(new Rect(0, y, inRect.width - 20, 20), maxPawns, 0, 20, true);
            y += 40;
        ...
        private void ApplyGlobalFocus()
        {
            ...
            if (worldComp != null)
            {
                worldComp.SetGlobalFocus(selectedWorkType, intensity, defocusMultiplier, maxPawns);
                Messages.Message("FreeWillGlobalFocusSet".Translate(selectedWorkType.labelShort), MessageTypeDefOf.PositiveEvent);
            }
            Close();
        }
        ...
        private void ClearGlobalFocus()
        {
            ...
            Messages.Message("FreeWillGlobalFocusCleared".TranslateSimple(), MessageTypeDefOf.SilentInput);
            Close();
        }
    }
}
